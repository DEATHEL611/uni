...
root = tk.Tk()
root.title("Chat de Recetas con Gemini")
...
chat_box.place(x=20, y=20, width=660, height=450)
...
entrada_usuario.place(x=20, y=520, height=40)
...
chat_box.tag_config("titulo", font=("Arial", 14, "bold"))
...
boton_enviar = Button(root, text="Enviar", font=("Arial", 14), command=obtener_receta, bg=colores_claros["boton"], fg=colores_claros["boton_texto"], relief="flat")
boton_enviar.place(x=580, y=520, height=40, width=100)
...
check_solo_ingredientes.place(x=20, y=570)
...
boton_modo.place(x=500, y=570, height=30, width=180)
